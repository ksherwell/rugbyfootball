<?php
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Templates.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Exports.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Users.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Rejects.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Inbound.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Tags.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Messages.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Whitelists.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Ips.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Internal.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Subaccounts.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Urls.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Webhooks.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Senders.php';
require_once Mage::getBaseDir( 'lib' ) . '/Junaidbhura/Mandrill/Exceptions.php';

class Junaidbhura_Mandrill {
    ...
    public function __construct($apikey=null) {
        ...
        $this->ch = curl_init();
        curl_setopt($this->ch, CURLOPT_USERAGENT, 'Mandrill-PHP/1.0.49');
